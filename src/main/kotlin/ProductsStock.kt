class ProductsStock {
    ...
    Product(
        ...
        "Tired of your noisy neighbouring? Play this untuned musical keyboard for two hours at home and your " +
                "neighbour will be ready to move to a building far away from youu",
        1003.00,
    "X4A"
    ))
}